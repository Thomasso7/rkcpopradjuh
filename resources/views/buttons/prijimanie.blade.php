...
<h2 class="texty">Prvé sv. prijímanie 2025/2026</h2>
<div class="podtexty">
    <p>
        V pondelok 29. septembra 2025 o 19:15 sa uskutočnilo I. stretnutie rodičov detí, ktoré pôjdu na 1. sv. prijímanie v kostole sv. Cyrila a Metoda v Poprade na Juhu v roku 2026. Nahrávku zo stretnutia si môžete vypočuť <a class="kancelaria" href="{{url('https://drive.google.com/file/d/1yc4HFqNYuombEYY5mQuZXdlmoCjdNwQi/view')}}">tu</a>.
        <br>
        <br>
        <b>Stretnutia prvoprijímajúcich detí, rodičov a súrodencov:</b>
        <br>
        <br>
        NEDEĽA 22.3.2026 o 14:00 – krížová cesta
        <br>
        NEDEĽA 22.2.2026 o 16:00
        <br>
        NEDEĽA 25.1.2026 o 16:00
        <br>
        NEDEĽA 30.11.2025 o 16:00
        <br>
        NEDEĽA 26.10.2025 o 16:00
        <br>
        <br>
        <b>Slávnosť 1. sv. prijímania</b>
        <br>
        <br>
        <b>Sobota 23.5.2026 o 10:00</b>
        <br>
        ZŠ Dostojevského
        <br>
        ...
        <br>
        <br>
        Krst detí pred 1. sv. prijímaním bude v piatok 22.5.2026.
    </p>
</div>
