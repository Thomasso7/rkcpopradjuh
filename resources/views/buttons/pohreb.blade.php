...
<h2 class="texty">Kresťanský pohreb</h2>
<div class="podtexty">
    <p>
        <b>Pohreb</b> je potrebné nahlásiť po dohode s pohrebnými službami <b>aspoň deň</b> pred termínom v kancelárii CENTRA FARNOSTI, ktorá sa nachádza v miestnosti, do ktorej sa prichádza po bezbariérovom prístupe cez bočný vchod do kostola sv. Cyrila a Metoda (z južnej strany) a doniesť <b>list o obhliadke mŕtveho.</b>
        <br>
        <br>
        <br>
        <br>
