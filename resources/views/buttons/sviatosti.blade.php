...
<h2 class="texty">Iniciačné sviatosti dospelých</h2>
<div class="podtexty">
    <p>
        <b>Dospelí</b> sa na <b>prijatie iniciačných sviatostí</b> (krst, birmovanie, prvé sv. prijímanie) pripravujú spoločne aj s farnosťou Poprad – mesto. <b>Príprava začína</b> na <b>začiatku októbra</b> a vrcholí prijatím sviatostí <b>na Veľkú noc.</b>
        <br>
        <br>
        <b>Nahlásiť</b> sa nám treba v kancelárii alebo telefonicky, či mailom <b>do konca septembra.</b>
        <br>
        <br>
        <br>
        <br>
