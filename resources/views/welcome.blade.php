...
<body>
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <a href="{{url('login')}}">
            <img class="login" src="{{asset('Subory/Person.png')}}" alt="Prihlásiť">
            </a>
        </div>
    </nav>
    <div class="omse-btn">
        <a class="omse-a" href="{{url('oznamy')}}">
            <button class="btn">
                Oznamy<br> sv. omše spovedanie
            </button>
        </a>
    </div>
    <img src="{{asset('Subory/denFarnosti.jpg')}}">
